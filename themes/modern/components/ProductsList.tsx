...
export default function ProductsList({
  ...
  const FilterSection = () => (
    <div className="space-y-6">
      {/* Category Filter */}
      <div>
        <h3 className="font-semibold text-gray-200 mb-3">Categories</h3>
      ...
      {/* Price Filter */}
      <div>
        <h3 className="font-semibold text-gray-200 mb-3">Price Range</h3>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          {showFilters && (
            <aside className="hidden lg:block w-64 flex-shrink-0">
              <div className="bg-black sharp-lg shadow p-6 sticky top-4">
                <FilterSection />
              </div>
            </aside>
          )}
            ...
            {filteredProducts.length === 0 ? (
              ...
              <div className={`grid ${gridCols[columns]} gap-6`}>
                {filteredProducts.map((product) => (
                  <div
                    key={product.id}
                    className="bg-white sharp-lg shadow hover:shadow-lg transition overflow-hidden group"
                  >
                    {/* Product Image */}
