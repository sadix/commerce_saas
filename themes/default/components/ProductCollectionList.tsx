...
export default function ProductsCollectionList({
  ...
  const FilterSection = () => {
    ...
    return(
    <div className="space-y-6" style={{ backgroundColor: colors.surface, borderRadius: shape.radiusLarge ,borderColor: colors.border}}>
            ...
            <div className="space-y-2">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="text-blue-600 focus:ring-blue-500"
                  onFocus={(e) => e.target.style.color = `${colors.primary}`}
                />
    ...
    <section className="py-16 bg-gray-50" style={{ backgroundColor:colors.surface}}>
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-2" style={{ fontFamily:typography.fontDisplay}}>{title}</h2>
              ...
              <div className={`grid ${gridCols[columns]} gap-6`}>
                {paginatedProducts.map((product) => (
                  <div
                    ...
                    style={{ backgroundColor: colors.surface , borderRadius: shape.radiusMedium}}
                  >
                    {/* Product Image */}
                    <div className="aspect-square bg-gray-200 overflow-hidden" style={{ backgroundColor: colors.primaryForeground}} onClick={() => setSelectedProduct(product)}>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {product.stock > 0 ? (
                          <button 
                            ...
                            className="px-4 py-2 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700 transition" style={{backgroundColor:colors.background, color:colors.accent}}
                          >
                            Add to Cart
                          </button>
                        ) : (
                  ...
                  >
                    ...
                    <div className="flex-1 p-6 flex flex-col justify-between">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {product.stock > 0 ? (
                          <button className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition" style={{backgroundColor:colors.background, color:colors.accent}}>
                            Add to Cart
                          </button>
                        ) : (
