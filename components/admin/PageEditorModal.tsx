  ...
  const availableBlocks = [
    ...
    
    {
    ...
    },
     {
      ...
      defaultProps: {
        title: 'About us',
        subtitle: 'We are your favorite shop',
    ...
    {
      type: 'CountDownSide',
      label: 'Countdown Side',
      defaultProps: {
        title: 'Countdown',
        due_date: (new Date(new Date().getTime() + 1000 * 60 * 60 * 24)),
        subtitle: 'Time remaining',
        description: 'This is a countdown component.',
        buttonText: 'Learn More',
        buttonLink: '/',
        backgroundImage: '/images/countdown-background.jpg',
      },
    },
    {
      type: 'HeroMansory',
      ...
      defaultProps:{
        title1: 'Titre 1',
        subtitle1 : 'Discover amazing products',
        buttonText1 : 'Shop Now',
        buttonLink1 : '/products',
        backgroundImage1 : "",

        title2: 'Titre 2',
        subtitle2 : 'Discover amazing products',
        ...
        title3: 'Titre 3',
        subtitle3 : 'Discover amazing products',
        buttonText3 : 'Shop Now',
        buttonLink3 : '/products',
        backgroundImage3 : "",
      }
    }
  ];
    ...
    return(
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-lg w-full max-w-7xl h-[90vh] flex flex-col">
          <div className="flex-1 overflow-hidden p-6 overflow-y-auto items-center">
              <h2 className="text-xl font-bold text-center"> Saving Layout </h2>
              <Loader2 className="w-100 h-100 animate-spin mx-auto" width={200} height={200} />
          </div>
        </div>
      </div>
    )
